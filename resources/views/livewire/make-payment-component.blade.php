	...
	<div class="payment padding-bt">
		<div class="osahan-header-nav shadow-sm p-3 d-flex align-items-center bg-danger">
			<h5 class="font-weight-normal mb-0 text-white">
				<a wire:navigate class="text-danger mr-3" href="{{ route('bus-seats', $this->bus_number) }}"><i class="icofont-rounded-left"></i></a>
				Payment
			</h5>
				...
				<div class="bg-white rounded-1 shadow-sm p-2 mb-2 w-100">
					<div class="row mx-0 px-1">
						<div class="col-12 p-0 mb-2">
							...
							<p class="small mb-0 l-hght-14"> {{ $this->bus->bus_histories?->first()->currentStation?->bus_station_name ?? 'N/A' }}</p>
						</div>
						<div class="col-12 p-0">
							<small class="text-danger mb-1 f-10 pr-1">Last Station</small>
							<p class="small mb-0 l-hght-14">{{ $this->bus->bus_histories?->first()->lastStation?->bus_station_name ?? 'N/A' }}</p>
						</div>
					</div>
				</div>
...
{{--				</div>--}}
	...
	<div class="fixed-bottom view-seatbt p-3">
		<a wire:click.prevent="initiatePayment" href="#!" class="btn btn-danger btn-block d-flex align-items-center osahanbus-btn rounded-1">
